...
func _process(delta):
	...
	$VBoxContainer/Question.text = mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].question
	$VBoxContainer/VBoxContainer/HBoxContainer/Option1/Label1.text = mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].option1
	$VBoxContainer/VBoxContainer/HBoxContainer/Option2/Label2.text = mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].option2
	$VBoxContainer/VBoxContainer/HBoxContainer2/Option3/Label3.text = mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].option3
	$VBoxContainer/VBoxContainer/HBoxContainer2/Option4/Label4.text = mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].option4
...
func _on_Submit_button_down():
	var correctAnswer = ""
	var question = mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].question
	
	if mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].correctAnswer == "1":
		correctAnswer = mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].option1
	elif mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].correctAnswer == "2":
		correctAnswer = mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].option2
	elif mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].correctAnswer == "3":
		correctAnswer = mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].option3
	elif mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].correctAnswer == "4":
		correctAnswer = mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].option4
	
	showingResult = 1
	
	if selectedAnswer == int(mainDictionary.quizDictionaryB[str(globalVariables.quizArray[currentQuizNumber])].correctAnswer):
